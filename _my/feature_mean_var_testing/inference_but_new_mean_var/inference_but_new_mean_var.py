...
if __name__ == "__main__":
    raise NotImplementedError("使用inference_but_update_mean_var.py")
    ...
    # model.pc_classifier_layer[0].running_mean = torch.tensor(np.load("_my/feature_mean_var_testing/cal_infset_mean_var/result/mean.npy"))
    # model.pc_classifier_layer[0].running_var = torch.tensor(np.load("_my/feature_mean_var_testing/cal_infset_mean_var/result/var.npy"))
    model.affinity_extractor.eval()
    # model.affinity_extractor[0].running_mean = torch.tensor(np.load("_my/feature_mean_var_testing/cal_infset_mean_var/result/mean.npy"))
    # model.affinity_extractor[0].running_var = torch.tensor(np.load("_my/feature_mean_var_testing/cal_infset_mean_var/result/var.npy"))
    # END TEST 找内鬼 ===
