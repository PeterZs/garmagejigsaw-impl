...
__C.STYLEXD.RANDOM_SAMPLE_NUM = None
...
__C.STYLEXD.PCS_SAMPLE_TYPE.STITCH = edict()
__C.STYLEXD.PCS_SAMPLE_TYPE.STITCH.ONLY_SAMPLE_BOUNDARY = False
...
__C.STYLEXD.SHRINK_BYSTITCH = edict()
__C.STYLEXD.SHRINK_BYSTITCH.TRAIN = False
__C.STYLEXD.SHRINK_BYSTITCH.VAL = False
__C.STYLEXD.SHRINK_BYSTITCH.INFERENCE = False
__C.STYLEXD.SHRINK_BYSTITCH_STRENGTH = edict()
__C.STYLEXD.SHRINK_BYSTITCH_STRENGTH.TRAIN = 0.
__C.STYLEXD.SHRINK_BYSTITCH_STRENGTH.VAL = 0.
__C.STYLEXD.SHRINK_BYSTITCH_STRENGTH.INFERENCE = 0.
