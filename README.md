...
Import the output of **GarmageJigsaw** into the **Style3D Studio** software and save it as a `.sproj` file. 

You should change `data_root` to the `<garmagenet-output-dir>/garmagejigsaw_output`.

> **This step run in style3d Studio** as a script (tool --> Python Script).

```
Copy the code of garmage_jigsaw/post_processing/json_2_sproj.py to the Style3D Studio script window.
